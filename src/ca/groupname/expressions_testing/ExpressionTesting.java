...
import static ca.groupname.logic.Operation.*;
...
public class ExpressionTesting {
    ...
    public ExpressionTesting() {
        ...
        x = new Variable<>("x", int.class, 6);
        y = new Variable<>("y", int.class, -25);
        s1 = new Variable<>("text1", String.class, "This string is for testing purposes ");
        s2 = new Variable<>("text2", String.class, "so is this one.");
        t = new Variable<>("true", boolean.class, true);
        f = new Variable<>("false", boolean.class, false);
